...
(function (factory) {
    ...
    const format_1 = __webpack_require__(7740);
    const parser_1 = __webpack_require__(8309);
...
(function (factory) {
    ...
    const scanner_1 = __webpack_require__(2122);
...
(function (factory) {
    ...
    const formatter = __webpack_require__(7740);
    const edit = __webpack_require__(5891);
    const scanner = __webpack_require__(2122);
    const parser = __webpack_require__(8309);
    /**
     * Creates a JSON scanner on the given text.
     * If ignoreTrivia is set, whitespaces or comments are ignored.
     */
