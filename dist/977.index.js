...
var signal_exit = __webpack_require__(4931);
...
function execaSync(file, args, options) {
	...
	let result;
	try {
		result = external_node_child_process_.spawnSync(parsed.file, parsed.args, parsed.options);
	} catch (error) {
		throw makeError({
			error,
			stdout: '',
...
;
//# sourceMappingURL=977.index.js.map